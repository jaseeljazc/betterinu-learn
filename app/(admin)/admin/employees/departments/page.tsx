...
import { DepartmentsTable } from "@/components/admin/employees/departments-table"
  ...
  return (
    <div className="w-full min-h-screen bg-subtle px-6 lg:px-10 py-10">
      <div className="mb-8">
        ...
        <p className="text-sm text-secondary">Manage organisational departments and their heads.</p>
      </div>

      <DepartmentsTable canEdit={canEdit} />
    </div>
  )
}
