...
export default function CourseEditPage() {
  ...
  >(null);
  const activeTab = "settings" as string;
          ...
          <div className={sectionClass}>
            ...
            <div className="flex flex-wrap gap-2">
              {(form.outcomes ?? []).map((o, i) => (
                <span
                  key={i}
                  className="flex items-center gap-1.5 rounded-full bg-subtle px-3 py-1.5 text-xs font-medium text-primary border border-default"
                >
                  {o}
                  <button
                    type="button"
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                onClick={addOutcome}
                className="flex items-center gap-1 rounded-lg bg-primary/10 px-3 py-2 text-sm font-semibold text-primary"
              >
