...
export function SubModuleItem({
  ...
  return (
    <div className="group flex flex-col gap-3 rounded-xl border border-default bg-surface/50 p-3 transition-all hover:bg-white hover:shadow-sm sm:flex-row sm:items-center">
      <Link
        className="flex min-w-0 flex-1 items-center gap-3 rounded-md focus-ring no-underline"
      ...
      >
        ...
        <span className="min-w-0">
          <span className="block truncate font-semibold text-foreground transition-colors group-hover:text-primary no-underline hover:no-underline group-hover:no-underline">
            {module.title}
          </span>
