                ...
                <div className="p-3">
                  ...
                  {active && unlocked ? (
                    <div className="mt-2.5 flex flex-col gap-0.5 border-t border-default pt-2">
                      ...
                      <a    className="w-full group flex items-center gap-2 rounded-sm px-2 py-1.5 text-[11px] text-secondary transition-colors hover:bg-subtle hover:text-foreground focus-ring"
                          href={`#${day.id}`}
                          key={day.id}
                        >
