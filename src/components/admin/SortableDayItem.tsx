      ...
      {!isDayCollapsed && (
        <div className="space-y-4 pt-2 border-t border-default/50 mt-2">
          ...
          {day.subModules?.map((mod: any, mIdx: number) => (
            <div key={mod.id} className="flex flex-col gap-3 bg-white border border-default rounded-xl p-4 text-sm shadow-sm transition-all focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20 relative z-10">
