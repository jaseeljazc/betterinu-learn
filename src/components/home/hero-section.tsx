...
export function HeroSection() {
  return (
    <section
      className="relative overflow-hidden rounded-lg border border-default bg-white"
    ...
    >
      ...
      {/* BG gradient splash */}
      <div
        className="pointer-events-none absolute -top-32 -right-32 size-96 rounded-full opacity-60"
        style={{
          background:
            "radial-gradient(circle, rgba(21,128,61,0.09), transparent 65%)",
          filter: "blur(60px)",
        }}
        aria-hidden
      />
      ...
      <div className="relative z-10 px-8 py-14 sm:px-14 lg:px-20">
        ...
        <p
          className="mt-6 max-w-xl text-[17px] leading-relaxed text-secondary animate-fade-up"
          style={{ animationDelay: "120ms" }}
        >
          Career-focused weekly courses with structured lessons, live quizzes,
          XP streaks, and unlockable progress — built for real outcomes.
        </p>
        ...
        {/* Stats row */}
        <div
          className="mt-14 grid grid-cols-2 gap-4 border-t border-default pt-8 sm:grid-cols-4 animate-fade-up"
